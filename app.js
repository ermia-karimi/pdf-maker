...
// document.getElementById("imagePicker").onchange = async (e) => {
//     const loading = document.getElementById("loadingMsg");
//     loading.style.display = "flex";  // نمایش پیام

//     pickedImages = [...e.target.files];
//     pickedImages.reverse();

//     // اینجا یک مکث کوچک برای اینکه UI فرصت نمایش پیدا کنه
//     await new Promise(r => setTimeout(r, 50));

//     // شبیه‌سازی لود (واقعی بودنش بستگی به پروژه داره)
//     for (let i = 0; i < pickedImages.length; i++) {
//         await new Promise(r => setTimeout(r, 5)); // می‌تونی بیشتر یا کمتر کنی
//     }

//     loading.style.display = "none"; // مخفی کردن بعد از لود
